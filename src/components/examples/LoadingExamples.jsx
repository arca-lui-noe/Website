...
export const HeavyDataPageWithLoading = withLoading(
	HeavyDataPage,
	"Loading heavy data..."
);
...
export function SectionLoadingPage() {
	...
	return (
		<div>
			...
			<LoadingOverlay
				isLoading={isSection1Loading}
				message="Loading section 1...">
				<div
					style={{
						padding: "20px",
			...
			<LoadingOverlay
				isLoading={isSection2Loading}
				message="Loading section 2...">
				<div
					style={{
						padding: "20px",
						border: "1px solid #ccc",
