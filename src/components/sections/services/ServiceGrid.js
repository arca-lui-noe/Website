        ...
        <div className="row justify-content-center">
          <div className="col col-lg-4 col-sm-6">
            <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
              ...
              <div className="decoration_image"><Image src="/images/shape/shape_paws.svg" alt="Pet Paws"/></div>
            </div>
          </div>
            ...
            <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
              <div className="title_wrap">
                <div className="item_icon">
                  <Image src="/images/icon/icon_pet_grooming.svg" alt="Pet Grooming"/>
                </div>
              ...
              <div className="item_price"><span>From $39 / complex</span></div>
              <Link className="btn_unfill" href="/services/asd">
                <span>Get Service</span>
                <i className="far fa-long-arrow-right"></i>
              </Link>
          ...
          <div className="col col-lg-4 col-sm-6">
            <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
              <div className="title_wrap">
                <div className="item_icon">
                  <Image src="/images/icon/icon_pet_training.svg" alt="Pet Training"/>
                </div>
              ...
              <div className="item_price"><span>From $27 / hour</span></div>
              <Link className="btn_unfill" href="/services/asd">
                <span>Get Service</span>
                <i className="far fa-long-arrow-right"></i>
              </Link>
          ...
          <div className="col col-lg-4 col-sm-6">
            <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
              <div className="title_wrap">
                <div className="item_icon">
                  <Image src="/images/icon/icon_pet_taxi.svg" alt="Pet Taxi"/>
                </div>
              ...
              <div className="item_price"><span>From $22 / trip</span></div>
              <Link className="btn_unfill" href="/services/asd">
                <span>Get Service</span>
                <i className="far fa-long-arrow-right"></i>
              </Link>
          ...
          <div className="col col-lg-4 col-sm-6">
            <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
              <div className="title_wrap">
                <div className="item_icon">
                  <Image src="/images/icon/icon_pet_health.svg" alt="Pet Health & Wellness"/>
                </div>
              ...
              <div className="item_price"><span>From $39/ visit</span></div>
              <Link className="btn_unfill" href="/services/asd">
                <span>Get Service</span>
                <i className="far fa-long-arrow-right"></i>
              </Link>
          ...
          <div className="col col-lg-4 col-sm-6">
            <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
              <div className="title_wrap">
                <div className="item_icon">
                  <Image src="/images/icon/icon_pet_hotel.svg" alt="Pet Hotel"/>
                </div>
              ...
              <div className="item_price"><span>From $15 / night</span></div>
              <Link className="btn_unfill" href="/services/asd">
                <span>Get Service</span>
                <i className="far fa-long-arrow-right"></i>
              </Link>
