...
const ServiceDetailsSec2 = () => {
  return (
  <>
    <section className="service_section bg_gray section_space_lg" style={{ backgroundImage: 'url(images/shape/shape_paws_bg_2.svg)' }}>
        ...
        <div className="row">
            ...
            <div className="services_price_items_wrap">
              <div className="service_price_item">
                <div className="item_image">
                  <Image src="/images/service/service_img_1.jpg" alt="Pet Care Service"/>
                </div>
                ...
                <Link className="item_global_link" href="/services/asd"></Link>
              </div>

              <div className="service_price_item">
                <div className="item_image">
                  <Image src="/images/service/service_img_2.jpg" alt="Pet Care Service"/>
                </div>
                <div className="item_content">
                  <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="service_price_item">
                <div className="item_image">
                  <Image src="/images/service/service_img_3.jpg" alt="Pet Care Service"/>
                </div>
                <div className="item_content">
                  <div className="d-flex justify-content-between align-items-center">
          ...
          <div className="col col-lg-6">
            <div className="services_price_items_wrap">
              <div className="service_price_item">
                <div className="item_image">
                  <Image src="/images/service/service_img_4.jpg" alt="Pet Care Service"/>
                </div>
                <div className="item_content">
                  <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="service_price_item">
                <div className="item_image">
                  <Image src="/images/service/service_img_5.jpg" alt="Pet Care Service"/>
                </div>
                <div className="item_content">
                  <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="service_price_item">
                <div className="item_image">
                  <Image src="/images/service/service_img_6.jpg" alt="Pet Care Service"/>
                </div>
                <div className="item_content">
                  <div className="d-flex justify-content-between align-items-center">
