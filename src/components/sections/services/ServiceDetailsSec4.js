                ...
                <div className="testimonial_admin">
                  <div className="admin_thumbnail">
                    <Image
                      width={30}
                      height={30}
                      src="/images/meta/thumbnail_img_1.png"
            ...
            <SwiperSlide className="carousel_item">
              <div className="testimonial_item">
                <div className="testimonial_admin">
                  <div className="admin_thumbnail">
                    <Image
                      width={30}
                      height={30}
                      src="/images/meta/thumbnail_img_2.png"
                      alt="Pet Thumbnail Image"
                    />
                  </div>
                  <div className="admin_info">
                ...
                <p className="mb-0">
                  ...
                  enim. Tellus in hac habitasse platea dictumst{" "}
                </p>
                <span className="quote_icon">
                  <i className="fas fa-quote-right"></i>
                </span>
                ...
                <div className="testimonial_admin">
                  <div className="admin_thumbnail">
                    <Image
                      width={30}
                      height={30}
                      src="/images/meta/thumbnail_img_4.png"
                      alt="Pet Thumbnail Image"
                    />
                  </div>
                  <div className="admin_info">
...
export default ServiceDetailsSec4;
