      ...
      <div className="container">
        ...
        <div className="row justify-content-center">
          <div className="col col-lg-4 col-sm-6">
            <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
              <div className="title_wrap">
                <div className="item_icon"><Image src="/images/icon/icon_pet_training.svg" alt="Pet Training"/></div>
              ...
              <Link className="btn_unfill" href="service_details"> <span>Get Service</span> <i className="far fa-long-arrow-right"></i></Link>
          ...
          <div className="col col-lg-4 col-sm-6">
            <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
              <div className="title_wrap">
                <div className="item_icon"><Image src="/images/icon/icon_pet_grooming.svg" alt="Pet Grooming"/></div>
          ...
          <div className="col col-lg-4 col-sm-6">
            <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
              <div className="title_wrap">
                <div className="item_icon"><Image src="/images/icon/icon_pet_walking.svg" alt="Pet Walking"/></div>
              ...
              <div className="item_price"><span>From $15 / hour</span></div>
              <Link className="btn_unfill" href="service_details"> <span>Get Service</span> <i className="far fa-long-arrow-right"></i></Link>
              <div className="decoration_image"><Image src="/images/shape/shape_paws.svg" alt="Pet Paws"/></div>
            </div>
          </div>
