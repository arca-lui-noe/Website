        ...
        <div className="row justify-content-center">
          <div className="col col-lg-4 col-sm-6">
            <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
              <div className="title_wrap">
                <div className="item_icon"><Image  width={30}
            height={30} src="/images/icon/icon_pet_training.svg" alt="Pet Training"/></div>
              ...
              <div className="decoration_image"><Image  width={30}
            height={30} src="/images/shape/shape_paws.svg" alt="Pet Paws"/></div>
            </div>
          </div>
          ...
          <div className="col col-lg-4 col-sm-6">
            <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
              <div className="title_wrap">
                <div className="item_icon"><Image  width={30}
            height={30} src="/images/icon/icon_pet_grooming.svg" alt="Pet Grooming"/></div>
          ...
          <div className="col col-lg-4 col-sm-6">
            <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
              <div className="title_wrap">
                <div className="item_icon"><Image  width={30}
            height={30} src="/images/icon/icon_pet_walking.svg" alt="Pet Walking"/></div>
