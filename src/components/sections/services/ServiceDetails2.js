...
const ServiceDetailss = () => {
  ...
  <section className="service_details_section section_space_lg">
    <div className="container">
      ...
      <div className="video_wrapper text-center" style={{ backgroundImage: 'url(/images/video/video_poster_image_2-min.jpg)' }}>
        <Link onClick={() => setOpen(true)} className="video_play_btn popup_video"><i className="fa-duotone fa-play" /></Link> 
      </div>
      ...
      <div className="row justify-content-center">
        <div className="col-lg-8">
          <div className="details_content mb-5">
            <h3 className="details_info_title">How a therapy can solve your problem?</h3>
            <p className="mb-4">
              ...
              <div className="col-md-6 col-sm-6">
                <ul className="info_list unordered_list_block mb-md-4">
                  <li>
                    ...
                    <span className="info_text">Realize you are not a victim</span>
                  </li>
                  <li>
                    <span className="info_icon">
                      <i className="fa-light fa-circle-check"></i>
              ...
              <div className="col-md-6 col-sm-6">
                <ul className="info_list unordered_list_block mb-4">
                  <li>
                    ...
                    <span className="info_text">Give a little; get a lot</span>
                  </li>
                  <li>
                    <span className="info_icon">
                      <i className="fa-light fa-circle-check"></i>
                    </span>
                    <span className="info_text">Do what you say you will do</span>
                  </li>
                  <li>
                    <span className="info_icon">
                      <i className="fa-light fa-circle-check"></i>
              ...
              <div className="col-lg-6">
                <div className="d-lg-flex text-lg-start justify-content-lg-start text-center justify-content-center align-items-center">
                  <div className="author_image">
                    <Image src="/images/meta/author_image_3-min.png" alt="Talking Minds - Psychotherapist React NextJs Template" />
                  </div>
                  <div className="author_content">
                    <h4 className="author_name">Dr. Merry Rose</h4>
                    <span className="author_designation mb-0">Practicing psychologist, Psy. D</span>
                  </div>
                </div>
              </div>
              <div className="col-lg-6">
    ...
    <div className="container">
      ...
      <div className="row justify-content-center">
        <div className="col-lg-4 col-md-6 col-sm-6">
          <div className="service_item">
            <div className="item_icon">
              <Image src="/images/icons/icon_brain.svg" alt="Brain Icon - Talking Minds – Psychotherapist React NextJs Template" />
            </div>
        ...
        <div className="col-lg-4 col-md-6 col-sm-6">
          <div className="service_item">
            <div className="item_icon">
              <Image src="/images/icons/icon_head_double.svg" alt="Head Double Icon - Talking Minds – Psychotherapist React NextJs Template" />
            </div>
            <div className="item_contact">
        ...
        <div className="col-lg-4 col-md-6 col-sm-6">
          <div className="service_item">
            <div className="item_icon">
              <Image src="/images/icons/icon_head.svg" alt="Brain Icon - Talking Minds – Psychotherapist React NextJs Template" />
            </div>
            <div className="item_contact">
      ...
      <div className="consultation_form bg_primary_light decoration_wrapper">
        <div className="section_heading text-center">
          <h2 className="section_heading_text mb-0">
            <span className="d-md-block">Get your first free</span> online consultation 
          </h2>
        </div>
        <div className="row justify-content-center">
        ...
        <div className="decoration_item shape_leaf_1">
          <Image src="/images/shapes/shape_leaf_right_top.svg" alt="Shape Leaf - Talking Minds - Psychotherapist React NextJs Template" />
        </div>
        <div className="decoration_item shape_leaf_2">
          <Image src="/images/shapes/shape_leaf_left_bottom.svg" alt="Shape Leaf - Talking Minds - Psychotherapist React NextJs Template" />
        </div>
      </div>
    </div>
  </section>
