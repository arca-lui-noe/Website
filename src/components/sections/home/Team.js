        ...
        <div className="container">
              ...
              <div className="team_item text-center">
                <div className="item_image">
                  <Image
                    width={30}
                    height={30}
                    src="/images/team/team_img_1.png"
                    alt="Team Image"
                  />
                </div>
              ...
              <div className="team_item text-center">
                <div className="item_image">
                  <Image
                    width={30}
                    height={30}
                    src="/images/team/team_img_2.png"
                    alt="Team Image"
                  />
                </div>
                <div className="item_content">
              ...
              <div className="team_item text-center">
                <div className="item_image">
                  <Image
                    width={30}
                    height={30}
                    src="/images/team/team_img_3.png"
                    alt="Team Image"
                  />
                </div>
                <div className="item_content">
              ...
              <div className="team_item text-center">
                <div className="item_image">
                  <Image
                    width={30}
                    height={30}
                    src="/images/team/team_img_4.png"
                    alt="Team Image"
                  />
                </div>
                <div className="item_content">
          ...
          <div className="text-center">
            <Link className="btn btn_primary" href="/services">
              <i className="fas fa-paw"></i> Our Team
            </Link>
          </div>
        </div>
      </section>
