  ...
  return (
    <>
      <section
        ...
        style={{ backgroundImage: "url(images/background/shape_bg_2.png)" }}
      >
          ...
          <div className="row align-items-center">
              ...
              <div className="feature_image">
                <div className="image_wrap">
                  <Image
                    width={30}
                    height={30}
                    src="/images/feature/feature_img_1.jpg"
                ...
                <div className="shape_image_1">
                  <Image
                    width={30}
                    height={30}
                    src="/images/shape/shape_butterfly.svg"
                    alt="Butterfly Shape"
                  />
                </div>
              </div>
            ...
            <div className="col col-lg-4">
              <div className="feature_content">
                ...
                <Link className="btn btn_primary" href="/services/asd">
                  {" "}
                  <i className="fas fa-paw"></i> Get Service{" "}
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="decoration_item shape_image_2">
          <Image
            width={30}
            height={30}
            src="/images/shape/shape_group_1.svg"
            alt="Pet Tools Box"
          />
        </div>
        <div className="decoration_item decoration_image_1">
          <Image
            width={30}
            height={30}
            src="/images/feature/feature_img_2.jpg"
            alt="Pet Grooming Service Image"
          />
        </div>
        <div className="decoration_item decoration_image_2">
          <Image
            width={30}
            height={30}
            src="/images/feature/feature_img_3.jpg"
            alt="Pet Grooming Service Image"
          />
        </div>
      </section>
