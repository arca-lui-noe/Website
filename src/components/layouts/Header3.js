...
export default function Header1({ scroll, handleMobileMenu, isSearch, dict, locale }) {
  ...
  return (
    <>
      <header
        className={`main-header header-style3 ${isSearch ? "moblie-search-active" : ""} ${
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-7 col-sm-9">
                <ul className="icon_list unorder_list justify-content-sm-end">
                  ...
                  <li>
                    <a href="mailto:arcaluinoe.noebarkaja@gmail.com" className="email-link">
          ...
          <div className="container">
            ...
            <div className="main-wrapper">
              <div className="logo-box">
                <div className="logo">
                  <Link href={`/${locale}`}>
                    <DynamicLogo locale={locale} scroll={false} isHomePage={isHomePage} />
                  </Link>
                </div>
              </div>
        ...
        <div className={`sticky-header ${scroll ? "fixed-header animated slideInDown" : ""}`}>
          <div className="container">
            <div className="main-wrapper">
              ...
              <div className="logo">
                <Link href={`/${locale}`}>
                  <DynamicLogo locale={locale} scroll={scroll} isHomePage={isHomePage} />
                </Link>
              </div>
